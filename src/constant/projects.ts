...
export const projects: Project[] = [
  ...
  },
  {
    name: "News App",
    description:
      "A website that provides information about the latest news from various sources. This website is created for final project 1 of Hacktiv8's Kampus Merdeka program. Created using ReactJS, Redux, and Tailwind CSS.",
  ...
  },
  {
    ...
    description:
      "Bukapedia is an ecommerce platform that allows users to browse and purchase various products online. This website is created for final project 2 of Hacktiv8's Kampus Merdeka program. Created using ReactJS, Redux, and Tailwind CSS.",
